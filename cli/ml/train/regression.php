...
class RegressionCli extends CLI
{
    ...
    const ML_FOLDER = __DIR__.'/../../../ml/regression';

    protected function setup(Options $options)
    {
        $options->setHelp('Trains a machine learning regression model.');
        $options->registerArgument('name', 'The name of the machine learning regression model.', true);
