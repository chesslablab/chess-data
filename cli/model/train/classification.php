...
class ClassificationCli extends CLI
{
    ...
    const MODEL_FOLDER = __DIR__.'/../../../model/classification';

    protected function setup(Options $options)
    {
        $options->setHelp('Trains an ML classification model.');
        $options->registerArgument('name', 'The name of the classification model.', true);
