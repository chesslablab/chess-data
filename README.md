...
PGN Chess is been developed following TDD principles, and it is been tested with dozens and
dozens of different [sample chess games](https://github.com/programarivm/pgn-chess/blob/master/tests/GameTest.php).
